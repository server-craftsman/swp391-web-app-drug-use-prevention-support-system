        ...
        <Modal
            title={
                <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-gray-800 mb-1">Tạo chương trình mới</h2>
                        <p className="text-sm text-gray-500">Tạo chương trình tư vấn và đào tạo mới</p>
                    </div>
                </div>
            }
            open={visible}
            ...
            className="create-program-modal"
        >
