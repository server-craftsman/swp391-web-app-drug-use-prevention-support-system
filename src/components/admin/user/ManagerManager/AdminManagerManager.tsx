...
import AdminDeleteManager from "./AdmindeleteManager"; // ✅ import modal xoá
...
const AdminManagerManager = () => {
  ...
  const [openDeleteModal, setOpenDeleteModal] = useState(false); // ✅ modal xoá
  ...
  const handleView = (record: UserResponse) => {
    message.info(
      `Xem chi tiết quản lý: ${record.lastName} ${record.firstName}`
    );
  };
