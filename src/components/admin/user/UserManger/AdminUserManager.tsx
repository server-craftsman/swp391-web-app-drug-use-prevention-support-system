...
import AdminCreateUserForm from "./AdminCreateUser"; // ✅ Thêm dòng này
...
const AdminUserManager = () => {
  ...
  const [createModalOpen, setCreateModalOpen] = useState(false); // ✅ Modal tạo user
    ...
    <div className="p-6 bg-white rounded-lg shadow-sm">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button
          ...
          icon={<PlusOutlined />}
          size="large"
          onClick={() => setCreateModalOpen(true)} // ✅ Mở modal
        >
          Thêm khách hàng mới
        </Button>
      </div>
      ...
      >
        <AdminCreateUserForm
          onSuccess={() => {
            ...
            fetchCustomers(); // ✅ Làm mới dữ liệu sau khi tạo
          }}
        />
      </Modal>
    </div>
