...
const AdminConsultantManager = () => {
    ...
    const handleView = (record: UserResponse) => {
        ...
        message.info(`Xem chi tiết tư vấn viên: ${record.lastName} ${record.firstName}`);
    };

    const handleEdit = (record: UserResponse) => {
        // TODO: Implement edit functionality
        message.info(`Chỉnh sửa tư vấn viên: ${record.lastName} ${record.firstName}`);
    };
    ...
    const columns: ColumnsType<UserResponse> = [
        ...
        },
        {
            ...
            key: "role",
            render: () => (
                <Tag color="purple">Tư vấn viên</Tag>
            ),
        },
        {
            title: "Ngày sinh",
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow-sm">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900">Quản lý Tư vấn viên</h2>
                    <p className="text-gray-600 mt-1">Quản lý đội ngũ tư vấn viên hệ thống</p>
                </div>
